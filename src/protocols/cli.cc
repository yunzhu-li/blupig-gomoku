...
bool RenjuProtocolCLI::beginSession(int argc, char const *argv[]) {
    ...
    for (int i = 0; i < argc; i++) {
        ...
        if (strncmp(arg, "-s", 2) == 0) {
            ...
            // for (int i = 0; i < 225; i++)
            //     gs_string[i] = '0';
            memcpy(gs_string, "", 362);
            ai_player = 2;
        }
    }
